...
import {DEFAULT_LIMIT_VALUES, DEFAULT_SEARCH_PARAMS} from 'custom-react-app/app/constants'

// original value is 25
DEFAULT_LIMIT_VALUES[0] = 3
DEFAULT_SEARCH_PARAMS.limit = 3

export const CUSTOM_HOME_TITLE = '🎉 Hello Integration X Example'

export {DEFAULT_LIMIT_VALUES, DEFAULT_SEARCH_PARAMS}

export * from 'custom-react-app/app/constants'
