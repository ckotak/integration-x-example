...
import Header from 'custom-react-app/app/components/header/index'
import {renderWithProviders, createPathWithDefaults} from 'custom-react-app/app/utils/test-utils'
import {rest} from 'msw'
import {createMemoryHistory} from 'history'
import {mockCustomerBaskets, mockedRegisteredCustomer} from 'custom-react-app/app/mocks/mock-data'

jest.mock('custom-react-app/app/components/shared/ui', () => {
    const originalModule = jest.requireActual('custom-react-app/app/components/shared/ui')
    return {
        ...originalModule,
